                ...
                <table class="min-w-max w-full table-auto">
                    <thead>
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            <th class="py-3 px-6 text-left">ID phòng </th>
                            ...
                            <th class="py-3 px-6 text-center">Ảnh phòng</th>
                            <th class="py-3 px-6 text-center">Số phòng</th>
                            <th class="py-3 px-6 text-center"></th>
                        </tr>
                    </thead>
                    <tbody class="text-gray-600 text-sm font-light">
                        <?php foreach ($list_tt as $value) {
                            extract($value);
                        ?>
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <span><?= $value['id_sanpham'] ?></span>
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <a href="">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <img class="w-24 h-12 border-gray-200 border transform hover:scale-125" src="<?php echo BASE_URL_ADMIN . "san-pham/images/" . $value['anh_sanpham'] ?>" />
                                ...
                                if ($value['so_luong'] == 0) {
                                    ...
                                    <span class='bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs'>Hết phòng</span>
                                </td>";
                                } else {
                                    echo " <td class='py-3 px-6 text-center'>
                                    <span class='bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs'>" . $value['so_luong'] . " phòng</span>
                                </td>";
                                }
                                ?>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <a href="<?= BASE_URL . "home/index.php?duyet_order" ?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <div class="flex w-10">
                                        ...
                                        <a href="http://" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
