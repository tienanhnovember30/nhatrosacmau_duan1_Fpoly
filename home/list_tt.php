                ...
                <table class="min-w-max w-full table-auto">
                    <thead>
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th class="py-3 px-6 text-center">Người đăng</th>
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <span><?php echo $value['diadiem_chitiet'] . ", " . $value['ten_diadiem'] ?></span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">

                                        <span><?php echo $value['ngay_nhap'] ?></span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <img class="w-6 h-6 rounded-full border-gray-200 border transform hover:scale-125" src="<?php echo BASE_URL_ADMIN . "/user/images/" . $value['avatar'] ?>" />
                                        <p class=" pl-2 font-bold"><?= $value['name'] ?></p>
                                    </div>
                                ...
                                <span class='bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs'>Hủy bài</span>
                            </td>";
                                } elseif ($value['trang_thai'] == 1) {
                                    echo " <td class='py-3 px-6 text-center'>
                                <span class='bg-yellow-200 text-yellow-600 py-1 px-3 rounded-full text-xs'>Chờ duyệt</span>
                            </td>";
                                } else {
                                    echo " <td class='py-3 px-6 text-center'>
                                <span class='bg-green-200 text-green-600 py-1 px-3 rounded-full text-xs'>Đã phê duyệt</span>
                                </td>";
                                }
                                ?>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        ...
                                        if ($value['trang_thai'] == 1) { ?>
                                            <a onclick="return confirm('Bạn có chắc chắn muốn phê duyệt bài viết này') " href="<?= BASE_URL . "home/index.php?update=" . $value['id_sanpham'] ?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        ...
                                        <?php } ?>
                                        <a href="<?= BASE_URL . "home/index.php?delete=" . $value['id_sanpham'] ?>" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
